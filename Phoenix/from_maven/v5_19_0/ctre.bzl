...
def __third_party_ctre_java():
    ...
    deps = []
    deps.append(("ctre-api-java", "com.ctre.phoenix:api-java:5.19.0", "792f9e2cf122eca4b007bafc794a5041100ffadc7b1f2c774687a7000870111d"))
    deps.append(("ctre-wpiapi-java", "com.ctre.phoenix:wpiapi-java:5.19.0", "7cbfa4ab2d6ee383dd3b4eb9edfa198ca2d9ed9755b4e5b5258542f9d1ed6abb"))
