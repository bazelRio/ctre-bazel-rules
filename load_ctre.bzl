"""
Loads the correct version of the CTRE repository
"""

def ctre_version_conf_impl(repository_ctx):
    """
    Rule for loading the specified version of the CTRE libraries
    ...
    build_file = Label("@ctre_bazel_rules//" + flattened_version + ":BUILD.bazel")
    repo_file = Label("@ctre_bazel_rules//" + flattened_version + ":ctre.bzl")
